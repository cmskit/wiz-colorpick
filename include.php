...
if (document.createStyleSheet){ document.createStyleSheet('wizards/colorpick/minicolors.css') }
else {$('head').append( $("<link rel='stylesheet' href='wizards/colorpick/minicolors.css' type='text/css' media='screen' />")) }
...
(function( $ ) {
	$.fn.colorpick = function(){
		this.minicolors({
			...
			swatchPosition: this.data('swatch-position') || 'left',
